...
class Dashboard extends Component {
  ...
  render() {
const{cars,users,bookings,customers} =this.state;
    return (
        ...
        <Row>
          <Col xs="12" sm="6" lg="3">
            <Card className="text-white bg-info">
              <CardBody className="pb-0">
                ...
                <div className="text-value">{customers.length}</div>
          ...
          <Col xs="12" sm="6" lg="3">
            <Card className="text-white bg-primary">
              <CardBody className="pb-0">
                <div className="text-value">{cars.length}</div>
                <div>Listed Cars</div>
              </CardBody>
              <div className="chart-wrapper mx-3" style={{ height: '70px' }}>
          ...
          <Col xs="12" sm="6" lg="3">
            <Card className="text-white bg-warning">
              <CardBody className="pb-0">
                <div className="text-value">{bookings.length}</div>
                <div>Bookings</div>
              </CardBody>
...
function mapStateToProps({ users, cars , bookings }) {
  return {
      users,
      cars,
      bookings
